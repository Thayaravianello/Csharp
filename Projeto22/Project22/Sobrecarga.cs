...
// AGORA IREMOS INSTANCIAR O PRODUTO APOS TER OS DADOS DO CLIENTE***********************************************************************************
            ...
            Produto p1 = new Produto(Nome, Preco, Quantidade); // TIPO DE CONSTRUTOR COM TRÊS PARÂMETROS
            Produto p2 = new Produto(); // TIPO DE CONSTRUTOR
            Produto p3 = new Produto(Nome, Preco); //TIPO DE CONSTRUTOR DIFERENTE

// TODOS OS TIPOS DE CONSTRUTORES POSSUEM PARÂMETROD DIFERENTES QUE PODE SER USADOS----------------------------------
